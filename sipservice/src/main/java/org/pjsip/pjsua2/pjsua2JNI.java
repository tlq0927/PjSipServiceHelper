...
public class pjsua2JNI {
  ...
  static {
	...
	System.err.println("Failed to load native library openh264_legrand\n" + e);
	System.out.println("This could be safely ignored if you " +
			   "don't use OpenH264_legrand video codec.");
    }
    try {
	System.loadLibrary("pjsua2_legrand");
    } catch (UnsatisfiedLinkError e) {
	System.err.println("Failed to load native library pjsua2_legrand\n" + e);
    }
  }
