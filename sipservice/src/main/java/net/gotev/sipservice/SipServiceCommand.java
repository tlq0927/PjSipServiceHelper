...
public class SipServiceCommand implements SipServiceConstants {
     ...
     */
    private static void enableSipDebugLogging(boolean enable) {
     ...
     * @return sip account ID uri as a string
     */
    private static String setAccountWithCodecs(Context context, SipAccountData sipAccount,
     ...
     * @param context application context
     */
    private static void restartSipStack(Context context) {
        Intent intent = new Intent(context, SipService.class);
    ...
    private static void makeCall(Context context, String accountID, String numberToCall, boolean isVideo, boolean isVideoConference) {
        makeCall(context, accountID, numberToCall, isVideo, isVideoConference, false);
    }

    private static void makeCall(Context context, String accountID, String numberToCall) {
        makeCall(context, accountID, numberToCall, false, false, false);
    }

    private static void makeCall(Context context, String accountID, String numberToCall, boolean isTransfer) {
     ...
     * @param numberToCall number to call
     */
    private static void makeSilentCall(Context context, String accountID, String numberToCall) {
        checkAccount(accountID);
     ...
     */
    private static void makeDirectCall(
            Context context,
            String guestName,
            Uri sipUri,
            String host,
    ...
    private static void makeDirectCall(Context context, String guestName, Uri sipUri, String host, boolean isVideo, boolean isVideoConference) {
     ...
     */
    private static void getCallStatus(Context context, String accountID, int callID) {
        checkAccount(accountID);
     ...
     * @param accountID account ID
     */
    private static void holdActiveCalls(Context context, String accountID) {
        checkAccount(accountID);
     ...
     */
    private static void sendDTMF(Context context, String accountID, int callID, String dtmfTone) {
        checkAccount(accountID);
    ...
    /**
     * Send unLock. If the call does not exist or has been terminated, a disconnected
     * state will be sent to
     * {@link BroadcastEventReceiver#onCallState(String, int, int, int, long)}
     * @param context application context
     * @param accountID account ID
     ...
     *                 You can send only one DTMF at a time.
     */
    public static void unLock(Context context, String accountID, int callID, String dtmfTone) {
        sendDTMF(context,accountID,callID,dtmfTone);
    }
    ...
    private static void acceptIncomingCall(Context context, String accountID, int callID) {
     ...
     */
    private static void transferCall(Context context, String accountID, int callID, String number) {
        checkAccount(accountID);
     ...
     */
    private static void attendedTransferCall(Context context, String accountID, int callIdOrig, int callIdDest) {
        checkAccount(accountID);
     ...
     */
    private static void setCallHold(Context context, String accountID, int callID, boolean hold) {
        checkAccount(accountID);
     ...
     * @param callID call ID
     */
    private static void toggleCallHold(Context context, String accountID, int callID) {
        checkAccount(accountID);
     ...
     * @param callID call ID
     */
    private static void toggleCallMute(Context context, String accountID, int callID) {
        checkAccount(accountID);
     ...
     * @param context application context
     */
    private static void getCodecPriorities(Context context) {
        Intent intent = new Intent(context, SipService.class);
     ...
     * @param codecPriorities list with the codec priorities to set
     */
    private static void setCodecPriorities(Context context, ArrayList<CodecPriority> codecPriorities) {
        Intent intent = new Intent(context, SipService.class);
     ...
     */
    private static void getRegistrationStatus(Context context, String accountID) {
        checkAccount(accountID);
    ...
    private static void refreshRegistration(Context context, String accountID, int regExpTimeout, String regContactParams){
        checkAccount(accountID);
    ...
    private static void setDND(Context context, boolean dnd) {
        Intent intent = new Intent(context, SipService.class);
     ...
     */
    private static void setVideoMute(Context context, String accountID, int callID, boolean mute) {
        checkAccount(accountID);
     ...
     */
    private static void changeVideoOrientation(Context context, String accountID, int callID, int orientation) {
        checkAccount(accountID);
     ...
     * @param callID call ID
     */
    private static void stopVideoPreview(Context context, String accountID, int callID) {
        checkAccount(accountID);
     ...
     */
    private static void reconnectCall(Context context) {
        Intent intent = new Intent(context, SipService.class);
     ...
     */
    private static void setCameraManager(CameraManager cm) {
     ...
     */
    private static void setVerifySipServerCert(Context context, boolean verify) {
